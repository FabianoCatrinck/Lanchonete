...
type
  TDados = class(TDataModule)
    ...
    ConsultaClienteIdICliente: TIntegerField;
    ConsultaClienteCodigoCliente: TIntegerField;
    ConsultaClienteNomeCliente: TStringField;
    ConsultaClienteData: TDateField;
    ConsultaPedidoIdCliente: TIntegerField;
  ...
  private
    ...
    function BuscarClienteCadastrado(const Codigo: String): Boolean;
  public
    { Public declarations }
    ...
    function BuscarCliente(const Codigo: String): Boolean;
  end;
...
function TDados.BuscarCliente(const Codigo: String): Boolean;
begin
  Result := BuscarClienteCadastrado(Codigo);
end;

function TDados.BuscarClienteCadastrado(const Codigo: String): Boolean;
var
  Consulta: TFDQuery;
begin
  ...
  try
    ...
    Consulta.SQL.Add('SELECT IdCliente FROM Cliente WHERE CodigoCliente = :CodigoCliente');

    Consulta.ParamByName('CodigoCliente').AsString := Codigo;
    Consulta.Open;
