...
begin
  ...
  try
    ...
    case GrupoTipoRelatorio.itemindex of
      0: begin
           Titulo := 'Total de pedidos realizados em um período';
      ...
      1: begin
           Titulo := 'Ingredientes mais utilizados';
           Consulta.SQL.Add(MontarSQLIngredientes());
         end;
      else
        begin
          Titulo := 'Lanches mais vendidos';
  ...
  // Cabeçalhos começam na linha 3
      for Col := 0 to Consulta.FieldCount - 1 do
        Worksheet.Cells[3, Col + 1] := Consulta.Fields[Col].DisplayName;
