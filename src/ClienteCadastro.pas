...
function TTelaClienteCadastro.GetIdCliente: Integer;
begin
  Result := FIdCliente;
end;
...
begin
  ...
  try
    try
      ...
      if Dados.BuscarCliente(editCodigo.Text) then
      begin
      ...
      Cliente.ParamByName('IdCliente').AsInteger := Dados.GerarId('Cliente', 'IdCliente');
      Cliente.ParamByName('CodigoCliente').AsString := editCodigo.Text;
      Cliente.ParamByName('NomeCliente').AsString := editNome.Text;
      Cliente.ParamByName('Data').AsDateTime := EditData.Date;
...
procedure TTelaClienteCadastro.SetNomeCliente(const Value: String);
begin
  FNomeCliente := Value;
end;

procedure TTelaClienteCadastro.SetData(const Value: TDate);
begin
  FData := Value;
end;

procedure TTelaClienteCadastro.SetIdCliente(const Value: Integer);
begin
  FIdCliente := Value;
end;
