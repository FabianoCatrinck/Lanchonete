...
begin
  ...
  try
    ...
    TelaIngredienteCadastro.Nome := Dados.ConsultaIngrediente.FieldByName('NomeIngrediente').AsString;
    TelaIngredienteCadastro.Valor := Dados.ConsultaIngrediente.FieldByName('Valor').AsFloat;
...
procedure TTelaIngredienteConsulta.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Dados.ConsultaIngrediente.Close;
end;

procedure TTelaIngredienteConsulta.FormCreate(Sender: TObject);
begin
  if not Dados.ConsultaIngrediente.Active then
    Dados.ConsultaIngrediente.CreateDataSet;

  DBGrid.DataSource := Dados.DataSourceIngrediente;
end;
